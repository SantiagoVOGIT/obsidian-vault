...
- **Tipos de la [[8. Biblioteca|bibliotecas]] estándar de Java**: Clases predefinidas del Java Development Kit ([[JDK|JDK]]) que ofrecen funcionalidades listas para usar, como `String`, `ArrayList`, `HashMap`, etc.
